...
*/
declare function sztest2<T extends ndarray = ndarray>( arrays: [ float32ndarray, float32ndarray, T, ndarray, float32ndarray, float32ndarray, float32ndarray, float32ndarray ] ): T;
